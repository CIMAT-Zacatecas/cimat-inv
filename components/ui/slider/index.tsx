...
const sliderStyle = tva({
  base: "items-center justify-center data-[disabled=true]:web:pointer-events-none data-[disabled=true]:web:opacity-40",
  variants: {
    orientation: {
      horizontal: "w-full",
      vertical: "h-full",
...
const sliderThumbStyle = tva({
  base: "absolute rounded-full bg-primary-500 shadow-hard-1 web:cursor-pointer web:active:outline web:active:outline-4 web:active:outline-primary-400 data-[focus=true]:bg-primary-600 data-[focus=true]:web:outline data-[focus=true]:web:outline-4 data-[focus=true]:web:outline-primary-400 data-[hover=true]:bg-primary-600 data-[active=true]:bg-primary-600 data-[disabled=true]:bg-primary-500",
