...
import { View, Pressable, Text, Platform, type TextProps } from "react-native";
...
const accordionTriggerStyle = tva({
  base: "w-full flex-row items-center justify-between px-5 py-5 focus:outline-none web:outline-none data-[focus-visible=true]:bg-background-50 data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-40",
});
